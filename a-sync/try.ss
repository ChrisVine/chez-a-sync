...
;; If none of the cond tests in the cond-clauses is found to be true
;; and there is no else clause, the exception condition will be
;; re-raised as if by raise, for a dynamically enclosing try form,
;; guard form or with-exception-handler form (if any) to handle.
;;
